                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-2 col-xl-2">
                    ...
                    <div class="single-footer">
                        ...
                        <ul>
                            ...
                            <li><a href="/orders">Userinfor</a></li>
                        </ul>
                    </div>
                    <!-- single-footer end -->
                </div>
                ...
                <div class="col-12 col-sm-12 col-md-8 col-lg-4 col-xl-4">
                    ...
                    <div class="single-footer">
                        ...
                        <div class="address-info">
                            <p><strong>Address: </strong> <span> Your address goes here</span></p>
                            <p><strong>Phone: </strong> <span> +010123456789</span></p>
                            <p><strong>Fax: </strong> <span> 0123456789</span></p>
