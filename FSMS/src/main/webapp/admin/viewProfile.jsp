                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title d-flex justify-content-between">
                                        ...
                                        <a class="edit-link" href="/admin/profile/edit"><i class="far fa-edit me-1"></i>Edit</a>
                                    </h5>
                                    <div class="row">
                                    ...
                                    <h5 class="card-title d-flex justify-content-between"><a class="edit-link" href="/admin/profile/changepassword"><i class="far fa-edit me-1"></i>Change Password</a>
                                    </h5>
