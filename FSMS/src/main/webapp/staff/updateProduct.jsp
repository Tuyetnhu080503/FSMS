                                        ...
                                        <div class="card-body">
                                            <form id="formCreateProduct" action="/upload/updateProduct" method="post" enctype="multipart/form-data">
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 col-sm-4">
                                                        <a id="banProduct" href="/staff/products/block/<%=product.getProductId()%>" style='display: none'><button class="mb-2 mr-2 btn-icon btn btn-danger"><i class="pe-7s-trash btn-icon-wrapper"></i>Lock Product</button></a> 
                                                        <a id="unbanProduct" href="/staff/products/unblock/<%=product.getProductId()%>" style='display: none'><button class="mb-2 mr-2 btn-icon btn btn-primary"><i class="pe-7s-tools btn-icon-wrapper"> </i>Unlock Product</button></a> 
                                                    </div>
