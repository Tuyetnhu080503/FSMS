                            ...
                            <form id="updateComment" action="/upload/updateComment"
                                ...
                                <div class="product-list">
                                        ...
                                        <table class="table-data-sheet">
                                            ...
                                            <tbody>
                                                <tr class="first">
                                                    ...
                                                    <td>
                                                        <input type="radio" value="1" name="vote-<%=rsC.getString("OrderItemsID")%>">
                                                    </td>
                                                    <td>
                                                        <input type="radio" value="2" name="vote-<%=rsC.getString("OrderItemsID")%>" >
                                                    </td>
                                                    <td>
                                                        <input type="radio" value="3" name="vote-<%=rsC.getString("OrderItemsID")%>">
                                                    </td>
                                                    <td>
                                                        <input type="radio" value="4" name="vote-<%=rsC.getString("OrderItemsID")%>">
                                                    </td>
                                                    <td>
                                                        <input type="radio" value="5" name="vote-<%=rsC.getString("OrderItemsID")%>" checked>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>															
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div style="margin-bottom: 30px" class="form-group students-up-files" data-orderItemID="<%=rsC.getInt("OrderItemsID")%>">
                                            ...
                                            <div style="margin-bottom: 20px" class="profile-image">
                                                <img style="display:none;" class="avatarImg" width="100" alt="User Image"
                                                     src="">
                                            </div>
                                            <div class="upload">
                                    ...
                                    <div style="display: flex;justify-content: end">
                                        <input type="hidden" name="createComment" value="createComment">
                                        <input type="hidden" name="ids" value="<%=orderItemsStr.substring(1)%>">
                                        <button type="submit" style="background:#ee4d2d ;border-color: #ee4d2d;color:white;" class="mb-2 mr-2 btn-icon btn-pill btn btn-outline-primary"><i class="feather-edit-3"></i>Create</button>
                                    </div>
                                </div>
                            </form>
                        </div>
