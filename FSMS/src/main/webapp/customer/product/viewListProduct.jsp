                ...
                <div class="right-main-product">
                    ...
                    <div class="product-sgorting-bar">
                        ...
                        <div class="view-systeam">
                            <ul>
                                <li><a href="/products"><i class="fa fa-th-large"></i></a></li>
                    ...
                    <!-- all-product start -->
                    <div id="all-products" class="row all-list-product">

                        <!-- single-product-item start -->
                        <% for (int idx = start; idx < end; idx++) {
                                Product product = products.get(idx);
                        %>
                        <div class="col-12 col-md-12 col-lg-12 col-xl-12 product-item-e">
                        ...
                        <div class="category-list-pro sidebar-list">
                            ...
                            <ul>
                                <% CategoryDAO catDAO = new CategoryDAO();
                                    ...
                                    while (r.next()) {
                                %>
                                <li><a href="/products/list2?id=<%=r.getString("CategoryID")%>"><%= r.getString("category_name")%></a>
