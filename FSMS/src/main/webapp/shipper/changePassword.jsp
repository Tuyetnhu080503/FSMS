                                                    ...
                                                    <div class="checkout-method">
                                                        <div class="row">
                                                            ...
                                                            <div class="method-right col-12 col-md-12">
                                                                <form id="changePassword" action="/shipper/profile/changepassword" method="post" style="margin-top: 10px">
                                                                    ...
                                                                    <div class="block-button-left">
                                                                        ...
                                                                        <a href="/shipper/profile" style="margin-left: 10px" class="btn btn-primary" >Back</a  >
                                                                    </div>
                                                                </form>
                                                            </div>
                                                        </div>
